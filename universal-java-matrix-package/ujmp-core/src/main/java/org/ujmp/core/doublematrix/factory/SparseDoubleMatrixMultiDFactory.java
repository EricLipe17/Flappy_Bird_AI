...
public interface SparseDoubleMatrixMultiDFactory<T extends SparseDoubleMatrixMultiD> extends
		SparseNumberMatrixMultiDFactory<T>, SparseDoubleMatrixFactory<T>,
