...
public class TransposeBenchmarkTask extends AbstractBenchmarkTask {

	public TransposeBenchmarkTask(long benchmarkSeed, Class<? extends DoubleMatrix2D> matrixClass,
			BenchmarkConfig config) {
		super(benchmarkSeed, matrixClass, config.getTransposeSizes(), config);
	}
