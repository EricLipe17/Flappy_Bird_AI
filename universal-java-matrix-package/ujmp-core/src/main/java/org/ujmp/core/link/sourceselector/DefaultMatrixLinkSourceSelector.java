...
public class DefaultMatrixLinkSourceSelector extends AbstractMatrixLinkSourceSelector {
	...
	public DefaultMatrixLinkSourceSelector() {
	}
	...
	public MatrixFileLinkSource file(String file) throws IOException {
		return new DefaultMatrixFileLinkSource(file);
	}

	public MatrixStringLinkSource string(String string) {
		return new DefaultMatrixStringLinkSource(string);
	}
