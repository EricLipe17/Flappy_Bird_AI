...
public class DefaultMatrixStringImportSource extends AbstractMatrixStringImportSource {

	public DefaultMatrixStringImportSource(Matrix matrix, String string) {
		super(matrix, string);
	}
