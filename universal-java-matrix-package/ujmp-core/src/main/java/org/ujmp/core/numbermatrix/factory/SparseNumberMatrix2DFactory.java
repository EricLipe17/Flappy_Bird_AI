...
public interface SparseNumberMatrix2DFactory<T extends SparseNumberMatrix2D<?>> extends
		SparseNumberMatrixFactory<T>, NumberMatrix2DFactory<T>, SparseGenericMatrix2DFactory<T> {
}
