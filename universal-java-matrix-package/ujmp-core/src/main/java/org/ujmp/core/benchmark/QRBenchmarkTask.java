...
public class QRBenchmarkTask extends AbstractBenchmarkTask {

	public QRBenchmarkTask(long benchmarkSeed, Class<? extends DoubleMatrix2D> matrixClass,
			BenchmarkConfig config) {
		super(benchmarkSeed, matrixClass, config.getQRSizes(), config);
	}
