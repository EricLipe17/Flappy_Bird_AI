...
public interface DenseNumberMatrix2DFactory<T extends DenseNumberMatrix2D<?>> extends
		DenseNumberMatrixFactory<T>, NumberMatrix2DFactory<T>, DenseGenericMatrix2DFactory<T> {
}
