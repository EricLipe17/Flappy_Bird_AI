...
class TimesMatrixMatrix implements TimesMatrixCalculation<Matrix, Matrix, Matrix> {
...
class TimesMatrixDenseMatrix implements
		TimesMatrixCalculation<DenseMatrix, DenseMatrix, DenseMatrix> {
...
class TimesMatrixSparseMatrix implements
		TimesMatrixCalculation<SparseMatrix, SparseMatrix, SparseMatrix> {
...
class TimesMatrixDenseMatrix2D implements
		TimesMatrixCalculation<DenseMatrix2D, DenseMatrix2D, DenseMatrix2D> {
...
class TimesMatrixDenseDoubleMatrix2D implements
		TimesMatrixCalculation<DenseDoubleMatrix2D, DenseDoubleMatrix2D, DenseDoubleMatrix2D> {
