...
public class DefaultDenseStringMatrix2DFactory extends
		AbstractDenseStringMatrix2DFactory<DenseStringMatrix2D> {

	public DenseStringMatrix2D zeros(long rows, long columns) {
