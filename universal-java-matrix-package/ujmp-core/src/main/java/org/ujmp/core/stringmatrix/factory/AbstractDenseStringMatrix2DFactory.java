...
public abstract class AbstractDenseStringMatrix2DFactory<T extends DenseStringMatrix2D> extends
		AbstractMatrixFactory<T> implements DenseStringMatrix2DFactory<T> {
